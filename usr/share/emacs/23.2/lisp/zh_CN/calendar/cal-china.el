...
;; FIXME unused.
(defcustom calendar-chinese-location-name "北京"
...
(defcustom calendar-chinese-daylight-time-zone-name "CDT 美国中部夏令时间"
...
(defun diary-chinese-date ()
  "中国农历行程事项."
  (format "农历: %s" (calendar-chinese-date-string date)))
