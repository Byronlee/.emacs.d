...
;;; 2013-05-15 00:55:04 CST translated
...
(define-key menu-bar-file-menu [open-file]
  '(menu-item "打開文件..." menu-find-file-existing
	      :enable (menu-bar-non-minibuffer-window-p)
	      :help "Read an existing file into an Emacs buffer"))
(define-key menu-bar-file-menu [new-file]
  '(menu-item "訪問新文件..." find-file
	      :enable (menu-bar-non-minibuffer-window-p)
...
(define-key menu-bar-search-menu [tags-srch]
  '(menu-item "搜索帶 Tag 標識的文件..." tags-search
...
(define-key menu-bar-replace-menu [tags-repl]
  '(menu-item "在帶 Tag 標識的文件中進行替換..." tags-query-replace
...
(define-key menu-bar-goto-menu [set-tags-name]
  '(menu-item "設置 Tag 標識文件名..." visit-tags-table
...
(define-key menu-bar-edit-menu [paste-from-menu]
  '(menu-item "從剪貼板(即 Kill 菜單)進行粘貼" yank-menu
...
(define-key menu-bar-edit-menu [copy]
  '(menu-item "復制" menu-bar-kill-ring-save
	      :enable mark-active
...
Do the same for the keys of the same name."
  ...
  (define-key menu-bar-edit-menu [copy]
    (cons "復制" (cons "復制選中的文字到剪貼板"
		       'clipboard-kill-ring-save)))
  (define-key menu-bar-edit-menu [cut]
    (cons "剪切" (cons "刪除選區內的文字并把它復制到剪貼板"
...
;(defvar menu-bar-preferences-menu (make-sparse-keymap "參數"))
...
;;; Assemble all the top-level items of the "選項" menu
...
(define-key menu-bar-showhide-menu [showhide-speedbar]
  '(menu-item "快捷欄" speedbar-frame-mode
...
(define-key menu-bar-showhide-menu [showhide-tooltip-mode]
  (list 'menu-item "工具欄提示" 'tooltip-mode
	:help "Turn tooltips on/off"
	:visible  `(and (display-graphic-p) (fboundp 'x-show-tip))
	:button `(:toggle . tooltip-mode)))

(define-key menu-bar-showhide-menu [menu-bar-mode]
  '(menu-item "菜單欄" toggle-menu-bar-mode-from-frame
	      :help "打開/關閉菜單欄"
	      :button (:toggle . (> (frame-parameter nil 'menu-bar-lines) 0))))

(define-key menu-bar-showhide-menu [showhide-tool-bar]
  (list 'menu-item "工具欄" 'toggle-tool-bar-mode-from-frame
	:help "打開/關閉工具欄"
	:visible `(display-graphic-p)
...
;  (list 'menu-item "參數" menu-bar-preferences-menu
;	:help "切換重要的全局選項"))
...
(define-key menu-bar-options-menu [line-wrapping]
  (list 'menu-item "在當前緩沖區換行" menu-bar-line-wrapping-menu))
...
(define-key menu-bar-tools-menu [encryption-decryption]
  (list 'menu-item "加密/解密" menu-bar-encryption-decryption-menu))
...
(define-key menu-bar-encryption-decryption-menu [export-keys]
  '(menu-item "導出密鑰" epa-export-keys
...
(define-key menu-bar-encryption-decryption-menu [import-keys]
  '(menu-item "從文件導入密鑰..." epa-import-keys
...
(let ((map minibuffer-local-map))
  (define-key map [menu-bar minibuf quit]
    (list 'menu-item "退出" 'abort-recursive-edit
