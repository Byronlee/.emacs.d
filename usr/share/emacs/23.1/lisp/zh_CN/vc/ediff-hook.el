...
(if (featurep 'xemacs)
  ...
  (define-key
    ...
    '(menu-item "目录修订版本..." ediff-merge-directory-revisions
  ...
  (define-key menu-bar-ediff-merge-menu [ediff-merge-revisions]
    '(menu-item "修订版本..." ediff-merge-revisions
  ...
  (define-key menu-bar-ediff-merge-menu [ediff-merge-directories]
    '(menu-item "目录..." ediff-merge-directories
  ...
  (define-key
    ...
    '(menu-item "带补丁包的缓冲区..." ediff-merge-buffers-with-ancestor
  ...
  (define-key menu-bar-ediff-merge-menu [ediff-merge-buffers]
    '(menu-item "缓冲区..." ediff-merge-buffers
  ...
  (define-key menu-bar-ediff-misc-menu [eregistry]
    '(menu-item "列出 Ediff 会话" ediff-show-registry
